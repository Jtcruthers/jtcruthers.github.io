            ...
            <DialogPanel class="relative flex w-full max-w-xs flex-1 flex-col bg-gray-800">
              ...
              <div class="h-0 flex-1 overflow-y-auto pt-5 pb-4">
                ...
                <nav class="mt-5 space-y-1 px-2">
                  <a v-for="item in navigation" :key="item.name" :href="item.href" :class="[item.current ? 'bg-gray-900 text-white' : 'text-gray-800 hover:bg-red-500 hover:text-white', 'group flex items-center px-2 py-2 text-base font-medium rounded-md']">
                    {{ item.name }}
                  </a>
                </nav>
              </div>
      ...
      <div class="flex min-h-0 flex-1 flex-col bg-red-400">
        <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
          ...
          <nav class="mt-5 flex-1 space-y-1 px-2">
            <a v-for="item in navigation" :key="item.name" :href="item.href" :class="[item.current ? 'bg-red-600 text-red-50' : 'text-gray-100 hover:bg-red-500 hover:text-white', 'group flex items-center px-2 py-2 text-sm font-medium rounded-md']">
              {{ item.name }}
            </a>
          </nav>
        </div>
